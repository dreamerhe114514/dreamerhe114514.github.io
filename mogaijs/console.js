...
//     }
    ...
    setFont=function(n){
        ...
        else if(n=="LXGWWenkai"){
            var s=document.querySelectorAll("body,.aplayer")
            for(var i = 0; i <s.length; i++) {
                s[i].style.fontFamily="Fredoka,LXGW WenKai,KyoukashoProL,-apple-system, IBM Plex Mono ,monospace,'寰蒋闆呴粦', sans-serif"
            }
        }
        else if(n=="HYPailou"){
            var s=document.querySelectorAll("body,.aplayer")
    ...
    if(localStorage.getItem("font")==undefined){
        localStorage.setItem("font","LXGWWenkai")
    }
...
// 璇诲彇鑳屾櫙
    ...
    if(localStorage.getItem("aplayerhide")=="true"){
        ...
        script.setAttribute('key','662c68aa9749c');
